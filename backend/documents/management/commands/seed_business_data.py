...
GROUPS = [
    {
        ...
        "status": DocumentGroup.STATUS_COMPLETED,
        "pipeline_step": "completed",
        "error": None,
        "validation_result": DocumentGroup.VALIDATION_VALID,
        "fraud_flags": [],
    ...
    },
    {
        ...
        "status": DocumentGroup.STATUS_FAILED,
        "pipeline_step": "compliance_checks",
        "error": "Business validation failed: SIRET mismatch between invoice and URSSAF certificate.",
        "validation_result": DocumentGroup.VALIDATION_INVALID,
