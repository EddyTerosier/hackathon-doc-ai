    ...
    if doc_type == "unknown":
        ...
        if current_siret:
            ...
            if any(other_siret != current_siret for _, other_siret in other_sirets):
                anomalies.append("SIRET facture incohérent avec les autres documents du dossier")
        ...
        if current_siret:
            ...
            if any(other_siret != current_siret for _, other_siret in other_sirets):
                anomalies.append("SIRET URSSAF incohérent avec les autres documents du dossier")
                fraud_flags.append("siret_mismatch")
